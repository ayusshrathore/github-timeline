	...
	if(isset($_POST['submit'])) {
		...
		if (array_filter($errors)) {
			...
			if(mysqli_query($conn, $sql)) {
				...
				$url = "http://localhost/github/verify.php?email=$email";
				$msg = "<b>Kindly verify your email using the below link</b> <br />" . "<a href=\"$url\">Verify</a>";
...
<html>
	...
	<section class="container grey-text">
		...
		<?php if ($is_submit) { ?>
			<p class="center">(We have sent you a verification link to your email. Kindly verify your email to receive updates)</p>
		<?php } ?>
